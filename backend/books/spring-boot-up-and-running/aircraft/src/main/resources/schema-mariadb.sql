...
CREATE TABLE aircraft (id BIGINT not null primary key auto_increment, callsign VARCHAR(7),
                       squawk VARCHAR(4), reg VARCHAR(10), flightno VARCHAR(10), route VARCHAR(25),
